  ...
  return (
    <>
      ...
      <section className="mt-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-12 order-3 order-lg-1">
              <div
                className={`card px-5 mb-3 border-0 bg-transparent ${styles.cards}`}
              >
              ...
              >
                <div className="card-body ">
                  ...
                  <p className={styles.text}>
                    vestibulum varius neque non posuere dapibus
                  </p>
                  <div className={styles.icons}>
                    <FontAwesomeIcon
                      className={styles.fabFacebookF}
                      icon={fabFacebookF}
                    />
                    <FontAwesomeIcon
                      className={styles.fabInstagram}
                      icon={fabInstagram}
                    />
                    <FontAwesomeIcon
                      className={styles.fabTwitter}
                      icon={fabTwitter}
                    />
                    <FontAwesomeIcon
                      className={styles.fabYoutube}
                      icon={fabYoutube}
                    />
                  </div>
                </div>
